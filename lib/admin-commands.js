...
function initFileWatcher() {
  try {
    // Usar watchFile con polling — más confiable que fs.watch en Linux
    // cuando el archivo es reemplazado completamente (writeFileSync)
    ...
    log('👁️ Watching admin-numbers.json para cambios en tiempo real');
  } catch (error) {
